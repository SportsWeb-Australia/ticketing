...
export default function ConfirmPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-brand-mist">
      <div className="print:hidden"><BrandHeader /></div>
      ...
      <main className="mx-auto w-full max-w-xl flex-1 px-4 py-8">
        {loading ? (
          ...
          <>
            ...
            <p className="mt-5 rounded-lg bg-white px-4 py-3 text-center text-sm text-slate-600 shadow-sm print:hidden">
            ...
            <div className="mt-3 text-center print:hidden">
              <button
                ...
                className="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:border-brand-orange"
              >
                Save ticket (PDF)
              </button>
            </div>
      ...
      <div className="print:hidden"><BrandFooter /></div>
    </div>
  );
}
